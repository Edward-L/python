...
def getPR(www):
	try:
		url = 'http://toolbarqueries.google.com/tbr?client=navclient-auto&ch=%s&features=Rank&q=info:%s' % (google_hash(www) , www)
...
def main():
	www = raw_input("pleace input the Domain name:")
	# print www
	# print google_hash(www)
	# print getPR(www)
	print getBR(www)
	return
